...
The power of Locomotive Scroll is now available to all Elementor users. And that changes a lot! No more old-fashioned scrolling that looks awful in Chrome or Safari. From now on any Section, Column or Widget can become a part of smooth scrolling with support for parallax effects, toggling classes, and triggering event listeners when elements are in the viewport. 
...
1.7.6 - Beware of the changes to the language file!
